...
function ContactFormWithSocialButtons() {
  const { hasCopied, onCopy } = useClipboard(site.mailAddress);
  const toast = useToast();

  const emailClickHandled = () => {
    onCopy();
            ...
            >
              ...
              >
                <IconButton
                  ...
                  onClick={emailClickHandled}
                  isRound
                />

                <Link
                  href={
                    site.sosyalMediaLinks.filter(
                      (s) => s.label === "facebook"
                    )[0].link
                  }
                  passHref
  ...
  return (
    <Box>
      <Head>
        ...
        <link rel="alternate" hreflang="tr" href={`${site.baseUrl}/contact`} />
        <link
          rel="alternate"
          hreflang="en"
        ...
        <meta property="og:url" content={`${site.baseUrl}/contact`} />
